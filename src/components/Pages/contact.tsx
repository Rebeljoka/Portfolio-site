...
export default function Contact() {
	...
	return (
		<section className="Contact text-white min-h-screen py-16 mt-64 mx-4 px-4 md:px-8">
			{/* Header Section */}
			<div className="max-w-4xl mx-auto mb-24">
				<div className="text-center">
					<h1 className="text-6xl md:text-8xl lg:text-9xl font-black noselect mb-8">
						Get in Touch
					</h1>
				...
				<div className="bg-linear-to-br from-white/10 to-white/5 backdrop-blur-lg border border-white/20 rounded-3xl p-10 md:p-16">
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						<div>
							<label
								htmlFor="name"
								className="block text-white/80 font-semibold mb-3"
							>
								Your Name
							</label>
							<input
						...
						<div>
							...
							<textarea
								...
								required
								rows={6}
								className="w-full px-6 py-4 bg-white/5 border border-white/20 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-white/50 focus:bg-white/10 transition-all duration-300 resize-none"
			...
			<div className="max-w-3xl mx-auto text-center">
				<div className="bg-linear-to-r from-white/5 to-white/5 border border-white/20 rounded-2xl p-12">
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/Rebeljoka"
							target="_blank"
							rel="noopener noreferrer"
							className="p-4 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full transition-all duration-300 hover:scale-110"
						>
							<FaGithub className="text-2xl" />
						</a>
						<a
							href="https://linkedin.com/in/habibu"
							target="_blank"
							rel="noopener noreferrer"
							className="p-4 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full transition-all duration-300 hover:scale-110"
						>
